...
Panel en tiempo real de las 50 criptomonedas con mayor capitalización de mercado, construido consumiendo la API pública de [CoinGecko](https://www.coingecko.com/en/api). Proyecto de portfolio: consumo de API externa, manejo de estados de carga/error, búsqueda, ordenación por columnas y una vista de detalle con mini-gráfico.
...
- Búsqueda asíncrona por nombre o símbolo
...
- Selector de moneda base (USD, GBP...) además de EUR
